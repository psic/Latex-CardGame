...
\pgfmathsetmacro{\imageheight}{0.71*\cardheight}
...
\newcommand{\cardcontent}[3]{
    ...
    \begin{scope}[shift={(0.25*\cardwidth,0.2*\cardheight)},scale=0.4]
    \fill [white](0,0) circle (0.63*\cardwidth);
    \end{scope}
    \begin{scope}[shift={(0.75*\cardwidth,0.2*\cardheight)},scale=0.4]
    \fill [white](0,0) circle (0.63*\cardwidth);
    \end{scope}
    \begin{scope}[shift={(0.5*\cardwidth,0.35*\cardheight)},scale=0.25]
        \fill [white](0,0) circle (0.69\cardwidth);
    \end{scope}
    
    
    % Black filler
    \begin{scope}
        \fill[cardcorners,white](-0.02,-0.02) rectangle(0.02+\cardwidth,0.02+0.30*\cardheight);
       \fill[cardcorners,black!10](0,0) rectangle(\cardwidth,0.30*\cardheight);
    \end{scope}
    ...
    \begin{scope}[shift={(0.25*\cardwidth,0.2*\cardheight)},scale=0.35]
...
%         \fill[black!70,rotate=145] (0,0.2)--(0:2.75) -- (0,-0.2)--cycle;
    ...
    \draw[draw=white,fill=green!30,thick] (135:2cm)-- (135:3.5cm) arc (135:180:3.5) -- (180:2cm) arc (180:135:2);
     \fill[elementcorners,white](-1.4,-0.9) rectangle(1.4,0.9);
    \fill[elementcorners,black](-1.3,-0.8) rectangle(1.3,0.8);
    \draw (0,0) node[white]{#3/4};


    \end{scope}
    \begin{scope}[shift={(0.75*\cardwidth,0.2*\cardheight)},scale=0.35]
        \fill [white](0,0) circle (3.9cm);
